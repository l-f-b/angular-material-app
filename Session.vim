...
silent only
cd ~/github/angular-material-app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +19 src/app/pages/bot-manager/bot-manager.service.ts
badd +0 src/app/pages/bot-manager/bot-manager.component.ts
badd +0 src/app/pages/file-manager/file-manager.component.ts
argglobal
silent! argdel *
$argadd .
edit src/app/pages/file-manager/file-manager.component.ts
...
let s:l = 51 - ((16 * winheight(0) + 8) / 17)
...
wincmd w
argglobal
if bufexists('src/app/pages/bot-manager/bot-manager.service.ts') | buffer src/app/pages/bot-manager/bot-manager.service.ts | else | edit src/app/pages/bot-manager/bot-manager.service.ts | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('src/app/pages/bot-manager/bot-manager.component.ts') | buffer src/app/pages/bot-manager/bot-manager.component.ts | else | edit src/app/pages/bot-manager/bot-manager.component.ts | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
